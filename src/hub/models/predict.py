...
# the same leave-one-out was run interpolating on the market's pick (`ecr + edge` where an
...
# of a null (ADR-0007): the market's rank imputes a prior season no better than consensus
