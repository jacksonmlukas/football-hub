...
PROP_LOG = Contract(
    ...
    required={"game_id": pl.Utf8, "player_key": pl.Utf8, "player": pl.Utf8,
              ...
              "our_p_over": pl.Float64, "our_p_push": pl.Float64,
              "our_p_over_close": pl.Float64, "our_p_push_close": pl.Float64,
              "side": pl.Utf8, "edge": pl.Float64,
    ...
    ranges={"our_p_over": (0, 1), "our_p_push": (0, 1), "our_p_over_close": (0, 1),
            "our_p_push_close": (0, 1), "edge": (-1, 1),
            "clv_prob": (-1, 1),
