...
FLOOR: dict[str, int] = {
    ...
    "src/hub/draft/availability.py": 19,
    ...
    "src/hub/season/lineup_gate.py": 30,
    "src/hub/season/pool.py": 3,
    "src/hub/season/roster.py": 0,
    "src/hub/season/survivor.py": 11,
    "src/hub/season/weekly_gate.py": 2,
